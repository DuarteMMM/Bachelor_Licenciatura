...
#define FNAME_DATA       "Prog30_01__Data.txt"
#define GNUPLOT_COMMAND  "gnuplot Prog30_01__Gnuplot"
...
show_help (int status)
{
  ...
  printf ("      -b=<valor>    : Taxa de desintegracao\n");
  printf ("\n");
  printf ("  Exemplo: Prog30_01 -x0=1000 -t0=0 -tf=10 -b=0.5 -dt=0.1\n");
  printf ("  Exemplo: Prog30_01 -x0=1000 -t0=0 -tf=10 -b=0.5 -dt=0.5\n");
  printf ("  Exemplo: Prog30_01 -x0=1000 -t0=0 -tf=10 -b=0.5 -dt=0.01\n");
  printf ("\n");
  exit (status);
}
...
/* 
     x -> solucao aproximada
     y -> solucao exacta
*/

  t = dados->t0;
  x = y = dados->x0;
  fprintf (fich1, "%12.4le  %12.4le  %12.4le\n", t, x, y);
  while (t < dados->tf)
    {
      // Solucao aproximada
