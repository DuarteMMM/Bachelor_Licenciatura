...
#define FNAME_DATA       "Prog33_02__Data.txt"
#define GNUPLOT_COMMAND  "gnuplot Prog33_02__Gnuplot"
...
{
  printf ("\n");
  printf ("  Prog33_02 -x0=<x inic> -xf=<x final> -y0=<Valor inicial> -dx=<incremento>\n");
  printf ("\n");
  printf ("    Exemplos:\n");
  printf ("      Prog33_02 -x0=0 -xf=8 -z0=1 -dx=0.2\n");
  printf ("      Prog33_02 -x0=0 -xf=8 -z0=1 -dx=0.1\n");
  printf ("      Prog33_02 -x0=0 -xf=8 -z0=1 -dx=0.01\n");
  printf ("\n"); 
  exit (status);
}
