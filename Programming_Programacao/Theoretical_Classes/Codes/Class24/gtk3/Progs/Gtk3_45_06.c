...
gchar *cssData =
  ".labelFrameDraw {color: red; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
  ".labelFrameComm {background-color: Wheat1; color: red; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
  ".btComm {color: DarkBlue; font-family: Tahoma; font-weight: bold; font-size: 10px;}\n";
...
int main(int argc, char *argv[])
{
  ...
  gtk_style_context_add_class (gtk_widget_get_style_context (frame1), "labelFrameDraw");
  ...
  gtk_style_context_add_class (gtk_widget_get_style_context (frame1), "labelFrameComm");
  gtk_frame_set_label_align (GTK_FRAME(frame1), 0.5, 0.0);
  ...
  gtk_style_context_add_class (gtk_widget_get_style_context (button1), "btComm");
