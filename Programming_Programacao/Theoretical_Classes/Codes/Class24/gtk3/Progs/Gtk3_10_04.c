...
gchar              *winTitle    = "GTK3-Ex: 'ComboBox' com 'model' e cor" ;

gchar *cssData = " #Label01 {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 16px;}\n"
                 " #Label02 {color: #000567; font-family: Tahoma; font-weight: bold; font-size: 12px;}\n"
                 " #ComboBox01 {color: #ff0000; font-family: Tahoma; font-weight: bold; font-size: 12px;}\n";
...
create_ComboBox_with_Model (void)
{
  ...
  //
  // As propriedades encontram-se em "GtkCellRendererText". Exemplo:
...
main (int argc, char **argv)
{
  ...
  gtk_widget_set_name (label2, "Label02");
