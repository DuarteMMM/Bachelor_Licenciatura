...
{
  GtkWidget *window, *darea, *hbox, *vbox1, *frame1, *button1 ;  
  ...
  gtk_box_pack_start (GTK_BOX(hbox), frame1, TRUE, TRUE, 3);
  ...
  gtk_box_pack_end (GTK_BOX(hbox), vbox1, FALSE, TRUE, 3);
  ...
  gtk_box_pack_end (GTK_BOX(vbox1), button1, FALSE, TRUE, 3);
