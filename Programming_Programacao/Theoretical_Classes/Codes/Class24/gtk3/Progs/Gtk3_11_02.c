...
gchar *cssData = "#window {background-color: Wheat1;}\n"
                 "@define-color colorButton #8e2323;\n"
                 "@define-color colorScale #0000ff;\n"
                 "@define-color colorScaleBack #0000ff;\n"
                 "@define-color colorExit #ff0000;\n"
                 "#Label01 {color: @colorButton; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
                 "#Scale01 {color: @colorScale; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
                 "#Button01 {color: @colorButton; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
                 "#ButtonExit {color: @colorExit; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
                 "#ComboBox01 {color: @colorButton; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n";
...
main (int argc, char **argv)
{
  ...
  scale = cria_scale ();
  gtk_widget_set_name (scale, "Scale01");
  ...
  gtk_widget_set_name (cbBox, "ComboBox01");
  ...
  gtk_widget_set_name (bt1, "Button01");
  ...
  gtk_widget_set_name (bt1, "ButtonExit");
  gtk_widget_set_size_request (bt1, 100, 15);
