...
gchar *cssData = "#window {background-color: Wheat1;}\n"
                 "#button1 {color: #ab0567; font-family: Tahoma; font-weight: bold; font-size: 14px;}\n"
		   ...
		   GtkWidget *win   ) 
{
  ...
  printf("teste: %d\n", teste);
  if (!teste)
    return TRUE;     // Nota este "TRUE" e necessario para o fecho correcto

  // Nota se se descomentar o callback associado a "destroy" (linha 88)
...
main (int argc, char **argv)
{
  ...
  gtk_widget_set_name (GTK_WIDGET(qmessage), "button1");
